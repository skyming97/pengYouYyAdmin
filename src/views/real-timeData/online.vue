<template>
  <div class="container">
    <el-row>
      <el-card shadow="hover">
        ...
        <el-row style="margin-bottom: 10px;">
          ...
          <el-col :span="4">
            <el-select v-model="valChannel" clearable placeholder="—— 渠道商 ——">
              <el-option
    ...
    <el-row>
      <el-card shadow="hover">
        <ve-line :data="chartData" :settings="chartSettings"  width="96%"></ve-line><!-- :extend="extend" -->
      </el-card>
    </el-row>
  </div>
</template>
